...
import { Crosshair, User, Users, CalendarDays, Trophy, UserCheck, Cake, Binary, Tag, ListOrdered, Edit, Shield } from 'lucide-react';
import { Button } from '../ui/button';
import Link from 'next/link';
import { PERMISSIONS } from '@/lib/permissions-master-list';
import { CricketBatIcon, WicketKeeperGloves } from '@/components/custom-icons';
    ...
    <div className="space-y-6">
      <Card className="overflow-hidden">
        ...
        <CardContent className="p-4 md:p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          ...
          {player.dominantHandBowling && <InfoItem icon={<Crosshair />} label="Bowling Hand" value={player.dominantHandBowling} />}
          {player.bowlingStyle && <InfoItem icon={<Crosshair />} label="Bowling Style" value={player.bowlingStyle} />}
          ...
          <InfoItem icon={<Crosshair />} label="Avg. Bowling" value={String(player.averageBowlingScore)} />
