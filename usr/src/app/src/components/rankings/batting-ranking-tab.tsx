...
import { Loader2, Info, User, ListOrdered, Gamepad2, TrendingUp } from 'lucide-react';
          ...
          <Table>
            ...
            <TableHeader className="bg-muted/50">
              <TableRow>
                ...
                <TableHead><User className="h-4 w-4 inline mr-1" />Bat Hand</TableHead>
                ...
                <TableHead className="text-right"><TrendingUp className="h-4 w-4 inline mr-1" />Avg. Bat Score (Series)</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
