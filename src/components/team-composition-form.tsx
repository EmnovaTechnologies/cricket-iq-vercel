            ...
            <FormItem>
              ...
              <Select value={ratingStatusFilter} onValueChange={(value) => onRatingStatusChange(value as 'all' | SeriesRatingStatus)}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="no_ratings">
                    <div className="flex items-center gap-2">
                      <Info className="h-4 w-4 text-muted-foreground" />
                      <span>No Rating Data</span>
                    </div>
                  </SelectItem>
                </SelectContent>
              </Select>
                      ...
                      {allSeriesPassed.map((series) => (
                        <SelectItem key={series.id} value={series.id}>
                           <div className="flex items-center gap-2">
                            ...
                            {series.ratingStatus === 'no_ratings' && <Info className="h-4 w-4 text-muted-foreground flex-shrink-0" title="This series has no game rating data." />}
